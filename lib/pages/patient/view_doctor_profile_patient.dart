...
class ViewDoctorProfilePatient extends StatefulWidget {
  ...
  const ViewDoctorProfilePatient(this.dataFromResponse, {Key key})
      : super(key: key);

  @override
  _ViewDoctorProfilePatientState createState() =>
      _ViewDoctorProfilePatientState(dataFromResponse);
}
...
class _ViewDoctorProfilePatientState extends State<ViewDoctorProfilePatient> {
  ...
  _ViewDoctorProfilePatientState(this.dataFromResponse);
